...
def pingpong(n):
    ...
    def pingpong_helper(value, index, direction):
        if index == n:
            ...
            return pingpong_helper(value + (direction == True)-(direction == False), index + 1, direction == False)
        else:
            return pingpong_helper(value + (direction == True)-(direction == False), index + 1, direction)
